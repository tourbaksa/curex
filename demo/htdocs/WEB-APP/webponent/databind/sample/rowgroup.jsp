...
<body>
<h4><div class="fl">rowgroup</div><div class="fr"><a href="index.jsp">목록</a></div><div class="clear"></div></h4>
	...
	<div class="fl">
		...
		<table summary="관심종목에 대한 종목코드, 종목명, 현재가, 전일비, 등락율, 거래량 항목을 제공합니다.">
			...
			<thead>
				...
				<tr>
					<th id="change">전일비</th>
					<th id="changeRatio">등락율</th>
					<th id="volumn">거래량</th>
				</tr>
			</thead>
			<tbody data-bind="_this.listItem(a.block)^_this.replaceItem(x32,x32.jcode)" data-rowgroup="2">
				<tr data-bindkey="code">
					<td headers="code" data-bind="code"></td>
					<td headers="name" data-bind="name"></td>
					<td headers="price" data-bind="price^curJuka"></td>
				</tr>
				<tr>
					<td headers="change" data-bind="change^debi"></td>
					<td headers="changeRatio" data-bind="changeRatio^dungrak"></td>
					<td headers="volumn" data-bind="volume^volume"></td>
				</tr>
			</tbody>
		</table>
	</div>
